...
if(isset($_POST['submit']) && $_POST['submit'] == 'Update'){
	...
	if(isset($_POST['password']) && $_POST['password'] !=''){
		...
		$FlatConn -> query("UPDATE `admin_tbl` SET `name` = '".$Name."', `mobile_no` = '".$MobileNo."', `email_id` = '".$EmailId."', `password` = '".base64_encode(base64_encode($Password))."', `school_id` = '".$SchoolId."', `is_active` ='".$IsActive."' WHERE `id` = '".$_POST['update_id']."' ");
