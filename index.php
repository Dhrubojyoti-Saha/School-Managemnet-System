...
<body class="login-page">
    <div class="login-box">
        ...
        <div class="card">
            ...
            <div class="body">
                <form id="sign_in" method="POST" action="login_success.php" onsubmit="return valid()">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            <button class="btn btn-block bg-pink waves-effect" type="submit" name="submit" id="submit" value="submit">SIGN IN</button>
                        </div>
                    </div>
